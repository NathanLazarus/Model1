...
function [KSTAR,LSTAR,CSTAR,stockSTAR,stable_dkplusdk]=model1_P_firstrun(P,LAMBDAZ,sigma_Z,BETTA,DELTA,ALFA,ETA,GAMA,SIGM,G,eta,ZSTAR,k_guess,c_guess,l_guess,...
